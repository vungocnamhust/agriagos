"""Refresh customer 360 view for organization id propagation.

Revision ID: 20260416_0025
Revises: 20260416_0024
Create Date: 2026-04-16 11:40:00
"""
...
PREVIOUS_CUSTOMER_360_VIEW_SQL = """
    CREATE OR REPLACE VIEW customer_360_view AS
    SELECT
        c.customer_id,
        jsonb_build_object(
...
def upgrade() -> None:
    ...
    alembic_op.execute(UPDATED_CUSTOMER_360_VIEW_SQL)


def downgrade() -> None:
    alembic_op.execute("DROP VIEW IF EXISTS customer_360_view")
    alembic_op.execute(PREVIOUS_CUSTOMER_360_VIEW_SQL)